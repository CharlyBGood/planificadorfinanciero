  ...
  if (loading) {
    return (
      <div className="bg-app p-4 rounded-lg">
        <h3 className="text-xl font-bold mb-4 text-center text-app">Historial de Transacciones</h3>
    ...
    <div className="bg-app p-4 rounded-lg">
      ...
      {filteredTransactions.length === 0 ? (
        <div className="py-8 flex items-center justify-center w-full flex-col">
          <h1 className="text-lg font-medium text-app-secondary">Aún no hay transacciones</h1>
        </div>
      ) : (
